...
for dome in os.listdir(dome_path):
    print(dome)

    img = datagen.load_imgs_from_directory(directory=dome_path, filter=dome, dims='TZXY')
    ...
    save_tiff_imagej_compatible(str(save_dome_path)+str(dome.split('.')[0])+'_denoised.tif', stack, axes='TZXY')